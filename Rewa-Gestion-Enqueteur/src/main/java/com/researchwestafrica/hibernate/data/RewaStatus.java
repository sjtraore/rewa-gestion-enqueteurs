...
public class RewaStatus implements Serializable {
	...
	@OneToMany(mappedBy="rewaStatus")
	private List<RewaPerson> rewaPersons;
	...
	public List<RewaPerson> getRewaPersons() {
		return this.rewaPersons;
	}

	public void setRewaPersons(List<RewaPerson> rewaPersons) {
		this.rewaPersons = rewaPersons;
	}

	public RewaPerson addRewaPerson(RewaPerson rewaPerson) {
	...
	public RewaPerson removeRewaPerson(RewaPerson rewaPerson) {
