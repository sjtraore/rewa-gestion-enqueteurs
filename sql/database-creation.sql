...
INSERT INTO `rewa_person` VALUES (1,'john','doe','jd','2018-09-27 14:52:50','2018-09-27 14:52:50',NULL,NULL,NULL,1,'jd'),(2,'Anna','Maria',NULL,'2018-09-27 15:05:37','2018-09-27 15:05:37',NULL,NULL,NULL,1,NULL),(3,'Don','Smith',NULL,'2018-09-27 15:16:42','2018-09-27 15:16:42',NULL,NULL,NULL,1,NULL),(4,'Richard','Ferdinand',NULL,'2018-09-27 16:36:02','2018-09-27 16:36:02',NULL,NULL,NULL,1,NULL),(5,'Louis','Richard2',NULL,'2018-09-27 16:48:21','2018-09-27 16:48:21',NULL,NULL,NULL,1,NULL),(6,'Louis','Seize',NULL,'2018-09-27 17:36:30','2018-09-27 17:36:30',NULL,NULL,NULL,1,NULL);
...
CREATE TABLE `rewa_person_level` (
  ...
  KEY `FK_PersonLevelRole_idx` (`idRole`),
  ...
  CONSTRAINT `FK_PersonLevelRole` FOREIGN KEY (`idRole`) REFERENCES `rewa_role` (`idRole`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-09-28 16:24:32
