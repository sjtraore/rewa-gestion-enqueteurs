...
@NamedQuery(name="RewaPerson.findAll", query="SELECT r FROM RewaPerson r")
public class RewaPerson implements Serializable {
	...
	//bi-directional many-to-one association to RewaPerson
	@OneToMany(mappedBy="rewaPerson1")
	private List<RewaPerson> rewaPersons1;
	...
	//bi-directional many-to-one association to RewaPerson
	@OneToMany(mappedBy="rewaPerson2")
	private List<RewaPerson> rewaPersons2;
	...
	public List<RewaPerson> getRewaPersons1() {
		return this.rewaPersons1;
	}

	public void setRewaPersons1(List<RewaPerson> rewaPersons1) {
		this.rewaPersons1 = rewaPersons1;
	}

	public RewaPerson addRewaPersons1(RewaPerson rewaPersons1) {
	...
	public RewaPerson removeRewaPersons1(RewaPerson rewaPersons1) {
	...
	public List<RewaPerson> getRewaPersons2() {
		return this.rewaPersons2;
	}

	public void setRewaPersons2(List<RewaPerson> rewaPersons2) {
		this.rewaPersons2 = rewaPersons2;
	}

	public RewaPerson addRewaPersons2(RewaPerson rewaPersons2) {
	...
	public RewaPerson removeRewaPersons2(RewaPerson rewaPersons2) {
